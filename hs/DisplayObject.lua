...
-- プロパティ定義
DisplayObject:setPropertyDef("width", "setWidth", "getWidth")
DisplayObject:setPropertyDef("height", "setHeight", "getHeight")
DisplayObject:setPropertyDef("priority", "setPriority", "getPriority")
DisplayObject:setPropertyDef("visible", "setVisible", "isVisible")
DisplayObject:setPropertyDef("enabled", "setEnabled", "isEnabled")
DisplayObject:setPropertyDef("focus", "setFocus", "isFocus")
DisplayObject:setPropertyDef("parent", "setParent", "getParent")
DisplayObject:setPropertyDef("physicsObject", "setPhysicsObject", "getPhysicsObject")
DisplayObject:setPropertyDef("layer", "setLayer", "getLayer")
DisplayObject:setPropertyDef("alpha", "setAlpha", "getAlpha")
DisplayObject:setPropertyDef("red", "setRed", "getRed")
DisplayObject:setPropertyDef("green", "setGreen", "getGreen")
DisplayObject:setPropertyDef("blue", "setBlue", "getBlue")
DisplayObject:setPropertyDef("prop", "setProp", "getProp")
DisplayObject:setPropertyDef("deck", "setDeck", "getDeck")
